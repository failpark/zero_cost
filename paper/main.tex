...
but these mechanisms introduce overhead generally considered incompatible with bare-metal systems programming\cite{oncd_report}.
...
overhead while maintaining equivalent safety to defensive runtime checks?
...
and session types\cite{honda_types_1993}, with minimal attention to empirical performance validation.
...
Only ARM64 architecture was tested; results may differ on x86-64 or other platforms,
though similar behavior is expected given LLVM's cross-platform optimization strategies.
